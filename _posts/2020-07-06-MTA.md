...
* Sending **two teams**, one to Manhattan and one to Brooklyn, will optimize the potential outreach based on foot traffic at subway stations across NYC.<br>
...
* <a href="https://github.com/eunchanity/davids_repo/blob/master/projects/project1_MTA/reports/project1_MTA_presentation.pdf" target="_blank">Presentation PDF in Github</a><br/>