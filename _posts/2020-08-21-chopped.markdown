---
layout: post
title: "Creating a Mystery Basket Generator from the TV Show Chopped"
...
![chopped]({{site.baseurl}}/assets/img/this-is-a-cooking-show-not-a-crying-show.png)
...
Given that the "documents" in my corpus were just single ingredients, I decided to use <b>word2vec</b> for my word embedding.

I created a <b>gensim model</b> by using Google's publicly available pre-trained word embeddings.

> This can be downloaded here <a href="https://drive.google.com/file/d/0B7XkCwpI5KDYNlNUTTlSS21pQmM/edit" target="_blank">https://drive.google.com/file/d/0B7XkCwpI5KDYNlNUTTlSS21pQmM/edit</a>
> Just note that this will require ~4GB of RAM to fit in memory
...
One thing to note here, is that the basket will always consist of four ingredients (like the show) no matter how many food types you select.
